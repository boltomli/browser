...
const EventListeners = struct {
    frame_remove: List = .empty,
    frame_created: List = .empty,
    frame_navigate: List = .empty,
    frame_navigated: List = .empty,
    frame_network_idle: List = .empty,
    frame_network_almost_idle: List = .empty,
    frame_child_frame_created: List = .empty,
    frame_dom_content_loaded: List = .empty,
    frame_loaded: List = .empty,
    http_request_fail: List = .empty,
    http_request_start: List = .empty,
    http_request_intercept: List = .empty,
    http_request_done: List = .empty,
    http_request_auth_required: List = .empty,
    http_request_served_from_cache: List = .empty,
    http_response_data: List = .empty,
    http_response_header_done: List = .empty,
    javascript_dialog_opening: List = .empty,
    console_message: List = .empty,
    runtime_console_message: List = .empty,
    model_context_tool_added: List = .empty,
    model_context_tool_removed: List = .empty,
    cookie_changed: List = .empty,
};
